		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsmodtodolistapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodtodolistapp-display": {
								"semanticObject": "comsmodtodolistapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.todolistapp",
									"url": sap.ui.require.toUrl("com/smod/todolistapp")
								}
							}
						}
					}
